...
struct PBGui_ScreenFrame: Sendable {
...
extension PBGui_InputKey: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UP\0\u{1}DOWN\0\u{1}RIGHT\0\u{1}LEFT\0\u{1}OK\0\u{1}BACK\0")
}

extension PBGui_InputType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0PRESS\0\u{1}RELEASE\0\u{1}SHORT\0\u{1}LONG\0\u{1}REPEAT\0")
}

extension PBGui_ScreenOrientation: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0HORIZONTAL\0\u{1}HORIZONTAL_FLIP\0\u{1}VERTICAL\0\u{1}VERTICAL_FLIP\0")
}
...
extension PBGui_ScreenFrame: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}data\0\u{1}orientation\0")
...
extension PBGui_StartVirtualDisplayRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}first_frame\0\u{3}send_input\0")
