...
extension PB_CommandStatus: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0OK\0\u{1}ERROR\0\u{1}ERROR_DECODE\0\u{1}ERROR_NOT_IMPLEMENTED\0\u{1}ERROR_BUSY\0\u{1}ERROR_STORAGE_NOT_READY\0\u{1}ERROR_STORAGE_EXIST\0\u{1}ERROR_STORAGE_NOT_EXIST\0\u{1}ERROR_STORAGE_INVALID_PARAMETER\0\u{1}ERROR_STORAGE_DENIED\0\u{1}ERROR_STORAGE_INVALID_NAME\0\u{1}ERROR_STORAGE_INTERNAL\0\u{1}ERROR_STORAGE_NOT_IMPLEMENTED\0\u{1}ERROR_STORAGE_ALREADY_OPEN\0\u{1}ERROR_CONTINUOUS_COMMAND_INTERRUPTED\0\u{1}ERROR_INVALID_PARAMETERS\0\u{1}ERROR_APP_CANT_START\0\u{1}ERROR_APP_SYSTEM_LOCKED\0\u{1}ERROR_STORAGE_DIR_NOT_EMPTY\0\u{1}ERROR_VIRTUAL_DISPLAY_ALREADY_STARTED\0\u{1}ERROR_VIRTUAL_DISPLAY_NOT_STARTED\0\u{1}ERROR_APP_NOT_RUNNING\0\u{1}ERROR_APP_CMD_ERROR\0\u{2}$ERROR_GPIO_MODE_INCORRECT\0\u{1}ERROR_GPIO_UNKNOWN_PIN_MODE\0")
}
...
extension PB_Main: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}command_id\0\u{3}command_status\0\u{3}has_next\0\u{1}empty\0\u{3}system_ping_request\0\u{3}system_ping_response\0\u{3}storage_list_request\0\u{3}storage_list_response\0\u{3}storage_read_request\0\u{3}storage_read_response\0\u{3}storage_write_request\0\u{3}storage_delete_request\0\u{3}storage_mkdir_request\0\u{3}storage_md5sum_request\0\u{3}storage_md5sum_response\0\u{3}app_start_request\0\u{3}app_lock_status_request\0\u{3}app_lock_status_response\0\u{3}stop_session\0\u{3}gui_start_screen_stream_request\0\u{3}gui_stop_screen_stream_request\0\u{3}gui_screen_frame\0\u{3}gui_send_input_event_request\0\u{3}storage_stat_request\0\u{3}storage_stat_response\0\u{3}gui_start_virtual_display_request\0\u{3}gui_stop_virtual_display_request\0\u{3}storage_info_request\0\u{3}storage_info_response\0\u{3}storage_rename_request\0\u{3}system_reboot_request\0\u{3}system_device_info_request\0\u{3}system_device_info_response\0\u{3}system_factory_reset_request\0\u{3}system_get_datetime_request\0\u{3}system_get_datetime_response\0\u{3}system_set_datetime_request\0\u{3}system_play_audiovisual_alert_request\0\u{3}system_protobuf_version_request\0\u{3}system_protobuf_version_response\0\u{3}system_update_request\0\u{3}storage_backup_create_request\0\u{3}storage_backup_restore_request\0\u{3}system_power_info_request\0\u{3}system_power_info_response\0\u{3}system_update_response\0\u{3}app_exit_request\0\u{3}app_load_file_request\0\u{3}app_button_press_request\0\u{3}app_button_release_request\0\u{3}gpio_set_pin_mode\0\u{3}gpio_set_input_pull\0\u{3}gpio_get_pin_mode\0\u{3}gpio_get_pin_mode_response\0\u{3}gpio_read_pin\0\u{3}gpio_read_pin_response\0\u{3}gpio_write_pin\0\u{3}app_state_response\0\u{3}storage_timestamp_request\0\u{3}storage_timestamp_response\0\u{3}property_get_request\0\u{3}property_get_response\0\u{3}app_get_error_request\0\u{3}app_get_error_response\0\u{3}app_data_exchange_request\0\u{3}desktop_is_locked_request\0\u{3}desktop_unlock_request\0\u{3}desktop_status_subscribe_request\0\u{3}desktop_status_unsubscribe_request\0\u{3}desktop_status\0\u{3}storage_tar_extract_request\0\u{3}gpio_get_otg_mode\0\u{3}gpio_get_otg_mode_response\0\u{3}gpio_set_otg_mode\0\u{3}app_button_press_release_request\0")
...
extension PB_Region: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}country_code\0\u{1}bands\0")
...
extension PB_Region.Band: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}start\0\u{1}end\0\u{3}power_limit\0\u{3}duty_cycle\0")
